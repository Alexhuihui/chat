...
path = "D:\\pycharm_projects\\chat\\wechat\\text.txt"
# 从路径读取报告全文，存为data
...
# 读图片
pic = Image.open("D:\\chrome_downloads\\china.jpg")
# 图片转数组
picarray = array(pic)
# collocations=False表示是否归并词，传入字体路径，图片数组，设置背景颜色为白色，用alldata生成词云
mywc = wc.WordCloud(collocations=False, font_path=font, mask=picarray, background_color="black").generate(alldata)
# 画布大小
